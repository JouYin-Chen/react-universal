...
/***/ function(module, exports, __webpack_require__) {
	...
	var _koa = __webpack_require__(63);
	...
	var _koaStatic = __webpack_require__(65);
	...
	function sendRenderResult(html, preloadedState) {
		return '<!doctype html>\n\t\t<html>\n\t\t<head><title>Universal Example</title></head>\n\t\t<body>\n\t\t\t<div id="app">' + html + '</div>\n\t\t\t<script>\n\t\t\t\twindow.__PRELOADED_STATE__ = ' + (0, _stringify2.default)(preloadedState).replace(/</g, '\\x3c') + '\n\t\t\t</script>\n\t\t\t<script src="/dist/bundle.js"></script>\n\t\t</body>\n\t</html>';
	}
	...
	function serverRenderWithRouterMiddwware(next) {
		...
		var history, initialState, store, routes, location, subscribeUrl;
		return _regenerator2.default.wrap(function serverRenderWithRouterMiddwware$(_context2) {
			while (1) {
				switch (_context2.prev = _context2.next) {
					...
					case 3:
						history = (0, _history.createMemoryHistory)(); //useRouterHistory(useQueries(createMemoryHistory))()
						// 建立一個 redux store
						...
						routes = (0, _routes2.default)(history);
						location = (0, _history.createLocation)(this.request.url); //history.createLocation(this.request.url)
						...
						(0, _reactRouter.match)({
							...
							if (redirectLocation) {
								_this.status = 301;
								_this.body = redirectLocation.pathname + redirectLocation.search;
							} else if (error) {
								_this.status = 500;
								_this.body = error.message;
							} else if (renderProps == null) {
								_this.status = 404;
								_this.body = 'Not found';
							} else {
								var reqUrl = location.pathname + location.search;

								var _subscribeUrl = subscribeUrl(),
								    _subscribeUrl2 = (0, _slicedToArray3.default)(_subscribeUrl, 2),
								    getCurrentUrl = _subscribeUrl2[0],
								    unsubscribe = _subscribeUrl2[1];
								...
								if (getCurrentUrl() === reqUrl) {
									_this.body = sendRenderResult(appHtml, reduxState);
									//res.render('index', {  html, scriptSrcs, reduxState, styleSrc })
								} else {
									_this.status = 301;
									_this.body = getCurrentUrl();
								}
							}
						});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (history) {
			return _react2.default.createElement(
					...
					_react2.default.createElement(
							_reactRouter.Route,
							{ path: '/' },
							_react2.default.createElement(_reactRouter.IndexRoute, { component: _rootindex2.default }),
	...
	var _rootindex = __webpack_require__(71);

	var _rootindex2 = _interopRequireDefault(_rootindex);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rootindex = __webpack_require__(76);
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ Add: _auth.Add, Del: _auth.Del }, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_rootindex2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DEL = exports.ADD = undefined;
	exports.Add = Add;
	exports.Del = Del;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RootIndex = function (_React$Component) {
	  (0, _inherits3.default)(RootIndex, _React$Component);
	  ...
	  function RootIndex() {
	    ...
	    (0, _classCallCheck3.default)(this, RootIndex);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = RootIndex.__proto__ || (0, _getPrototypeOf2.default)(RootIndex)).call.apply(_ref, [this].concat(args))), _this), _this.Add = function (e) {
	      e.preventDefault();
	      _this.props.Add();
	  ...
	  (0, _createClass3.default)(RootIndex, [{
	    ...
	    value: function render() {
	      var count = this.props.auth.count;
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(19)(Function.call, __webpack_require__(103).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStoreWithMiddleware = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default, loggerMiddleware), (typeof window === 'undefined' ? 'undefined' : (0, _typeof3.default)(window)) === 'object' && typeof window.devToolsExtension !== 'undefined' ? window.devToolsExtension() : function (f) {
	  return f;
	})(_redux.createStore);

	function configureStore(preloadedState) {
	  var store = createStoreWithMiddleware(_reducer2.default, preloadedState);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _auth = __webpack_require__(117);
